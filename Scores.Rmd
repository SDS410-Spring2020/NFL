...
How many scoring plays in a game? 
How many scoring plays in a season? 
- include game clock of each scoring play 
- include the scoreboard at each scoring play
- include each margin of victory for each game 
What is the percentage of scoring plays in a game? 
Biggest margin of victory 

organization: 
Season Record 
Team: SEA 
week 1  | game day | home | visitor | # of home scoring plays | # of visitor scoring plays | home_final | visitor_final | margin of victory
.
.
.
week 16  
Game Record 
week | game day | game clock | home | visitor | scoring play | | margin of victory

```{r}

```

Issue: missing scoring play 
- find first scoring play in a game 
- leave value of 0 in defensive team record 
