...
plays<-data %>% 
  ...
  mutate(pass=ifelse(str_detect(PlayDescription, "pass"), 1,0), 
         ...
         pass_incm_deep=ifelse(str_detect(PlayDescription,"pass incomplete deep"),1,0),
         pass_incm_deep_r=ifelse(str_detect(PlayDescription,"pass incomplete deep right"),1,0),
         pass_incm_deep_l=ifelse(str_detect(PlayDescription,"pass incomplete deep left"),1,0),
         pass_incm_short=ifelse(str_detect(PlayDescription,"pass incomplete short"),1,0),
         pass_incm_short_l=ifelse(str_detect(PlayDescription,"pass incomplete short left"),1,0),
         pass_incm_short_r=ifelse(str_detect(PlayDescription,"pass incomplete short right"),1,0),
         pass_short=ifelse(str_detect(PlayDescription,"pass short"),1,0),
         pass_short_l=ifelse(str_detect(PlayDescription,"pass short left"),1,0),
         pass_short_r=ifelse(str_detect(PlayDescription,"pass short_right"),1,0), 
         pass_deep=ifelse(str_detect(PlayDescription,"pass deep"),1,0), 
         pass_deep_r=ifelse(str_detect(PlayDescription,"pass deep right"),1,0),
         pass_deep_l=ifelse(str_detect(PlayDescription,"pass deep left"),1,0),
